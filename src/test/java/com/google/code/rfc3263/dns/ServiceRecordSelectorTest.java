...
public class ServiceRecordSelectorTest {
  ...
  public void testSelectByTarget() throws TextParseException {
    ...
    SRVRecord a = new SRVRecord(new Name("_sip._tcp.example.org."),
                                DClass.IN,
                                1000L,
                                1,
                                0,
                                5060,
                                new Name("a.sip.example.org."));
    SRVRecord b = new SRVRecord(new Name("_sip._tcp.example.org."),
                                DClass.IN,
                                1000L,
                                1,
                                0,
                                5060,
                                new Name("b.sip.example.org."));
    SRVRecord c = new SRVRecord(new Name("_sip._tcp.example.org."),
                                DClass.IN,
                                1000L,
                                1,
                                0,
                                5060,
                                new Name("c.sip.example.org."));
    SRVRecord d = new SRVRecord(new Name("_sip._tcp.example.org."),
                                DClass.IN,
                                1000L,
                                1,
                                0,
                                5060,
                                new Name("d.sip.example.org."));
